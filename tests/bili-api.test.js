...
test("用命名空间保存 YouTube 官方字幕来源，不伪装成 BV 号", () => {
  assert.equal(API.parseSourceId("youtube:dQw4w9WgXcQ"), "youtube:dQw4w9WgXcQ");
  assert.equal(API.parseSourceId("https://www.youtube.com/watch?v=dQw4w9WgXcQ"), "youtube:dQw4w9WgXcQ");
  assert.equal(API.canonicalVideoUrl("youtube:dQw4w9WgXcQ", 95), "https://www.youtube.com/watch?v=dQw4w9WgXcQ&t=95");
});
